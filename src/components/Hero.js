...
const Hero = () => {
    ...
    return (
        <div className='w-full h-screen relative text-white lg:bg-fixed bg-center bg-no-repeat bg-cover'
            ...
            <img src={before} alt='before' className='top-0 left-0 w-full h-screen object-cover absolute z-10 ease-in opacity-100 duration-[3s]' style={fadeOut ? { opacity: '0', transitionDelay: '1s' } : { opacity: '100' }} />
            ...
            <div className='absolute top-0 left-0 w-full h-full flex flex-col gap-4 justify-center items-center z-20'>
                <h1 className='text-white text-3xl md:text-5xl lg:text-6xl xl:text-7xl'>SMS <br className='sm:hidden' /> Construction & Remodeling</h1>
