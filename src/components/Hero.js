    ...
    return (
        <div className='w-full h-screen relative text-white'
            ...
            <div className='absolute top-0 w-full h-full flex flex-col justify-center items-center z-20'>
                <div className='flex flex-col items-center justify-center gap-8 bg-black/70 p-12 rounded-full'>
                    <h1 className='text-white text-3xl lg:text-8xl'>Transform Your Home</h1>
